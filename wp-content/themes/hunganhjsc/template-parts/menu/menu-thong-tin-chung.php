...
if ($menu2):
    ...
    <ul class="list-unstyled">
        ...
        <?php foreach ($menu2 as $menuItemTwo) : ?>
            <li>
                <a href="<?php echo $menuItemTwo->url ?>"
                   title="<?php echo $menuItemTwo->title ?>"><?php echo $menuItemTwo->title ?></a>
            </li>
        <?php endforeach; ?>
        <li class="bct_reg">
            <span style="font-size: 11px; color: #000; font-weight: 300;">SKF Authenticate App</span>
        </li>
        <?php $idImageThongTinChung = get_field('image_thong_tin_chung', 'option'); ?>
        <li>
            <a>
