                        ...
                        <li class="cart">
                            <a href="#" data-toggle="collapse"
                               data-target="#bs-navbar-collapse-search" aria-expanded="false"><img class="lazyload"
                                                                                                   src="./assets/imgs/icon-search-white.png"
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active ">
                    <a href="san-pham/vong-bi-skf.html" title="Vòng bi SKF chính hãng">
                        <img src="public/uploads/images/7730/vong-bi-skf.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Vòng bi SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="san-pham/mo-boi-tron-SKF.html" title="Mỡ SKF chính hãng">
                        <img src="public/uploads/images/7731/mo-boi-tron-skf.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Mỡ SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="san-pham/goi-do-skf.html" title="Gối đỡ SKF chính hãng">
                        <img src="public/uploads/images/7732/goi-do-skf.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Gối đỡ SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="san-pham/dung-cu-skf.html" title="Dụng cụ SKF chính hãng">
                        <img src="public/uploads/images/7733/dung-cu-bao-tri.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Dụng cụ SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="san-pham/phot-chan-skf.html" title="Phớt chặn SKF chính hãng">
                        <img src="public/uploads/images/7734/phot-chan-dau-skf.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Phớt chặn SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="dai-ly-uy-quyen-vong-bi-skf.html" title="Đại lý ủy quyền vòng bi SKF chính hãng">
                        <img src="public/uploads/images/7735/dai-ly-uy-quyen-skf.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Đại lý ủy quyền vòng bi SKF chính hãng">
                    </a>
                </div>
                <div class="item ">
                    <a href="tai-lieu-vong-bi/SKF-Authenticate.html" title="Kiểm tra vòng bi SKF giả (Fake)">
                        <img src="public/uploads/images/7736/skf-authenticate.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Kiểm tra vòng bi SKF giả (Fake)">
                    </a>
                </div>
                <div class="item ">
                    <a href="bao-gia-vong-bi-skf-chinh-hang.html" title="Giao hàng tận nơi 24/7">
                        <img src="public/uploads/images/7737/giao-hang-toan-quoc.jpg" width="1905" height="477"
                             class="lazyload img-full" alt="Giao hàng tận nơi 24/7">
                    </a>
                </div>
            </div>
