<footer>
    <div class="foot-top">
        ...
        <div class="hotline">
            ...
            <div class="container"><img class="lazyload" src="./assets/imgs/icons/icon-supportb90c.gif?v=2.5.9"
                                        alt="Báo giá vòng bi SKF" width="35" height="32"> <a
                    href="bao-gia-vong-bi-skf-chinh-hang.html"
                ...
                BI SKF CHÍNH HÃNG</a> - <span class="dot" style="margin-left: 5px; margin-top: -4px;"><span
                    class="ping"></span></span>Hotline: <a href="tel:096 123 8558"
                                                           title="báo giá vòng bi SKF chính hãng" rel="nofollow"><span
                    style="font-weight: 700;">096 123
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 col-xs-6 col">
                            <span class="icon"><img class="lazyload" src="./assets/imgs/icons/package.svg"
                                                    title="vòng bi skf chính hãng" alt="vòng bi skf chính hãng"
                                                    width="28"
                                                    height="28"></span>
                    ...
                    <div class="col-sm-3 col-xs-6 col">
                            <span class="icon"><img class="lazyload" src="./assets/imgs/icons/delivery.svg"
                                                    title="giao vòng bi tận nơi" alt="giao vòng bi tận nơi" width="36"
                                                    height="20"></span>
                        <span class="text"
                              style="font-weight: 500; font-size: 14px;  text-transform: uppercase;">giao hàng toàn
                                quốc 24/7</span>
                    </div>
                    <div class="col-sm-3 col-xs-6 col">
                            <span class="icon"><img class="lazyload" src="./assets/imgs/icons/recycle.svg"
                                                    title="bảo hành vòng bi linh hoạt" alt="bảo hành vòng bi linh hoạt"
                                                    width="30"
                                                    height="30"></span>
                        <span class="text"
                              style="font-weight: 500; font-size: 14px;  text-transform: uppercase;">bảo hành chính
                                hãng</span>
                    </div>
                    <div class="col-sm-3 col-xs-6 col">
                            <span class="icon"><img class="lazyload" src="./assets/imgs/icons/call-center.svg"
                                                    title="Hỗ trợ kỹ thuật vòng bi 24/7"
                                                    alt="Hỗ trợ kỹ thuật vòng bi 24/7" width="30"
                                                    height="30"></span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-info">
                    ...
                    <div style="padding-bottom: 5px; padding-top: 3px;"><a
                            href="dai-ly-uy-quyen-vong-bi-skf.html"><img class="lazyload"
                                                                         src="./assets/imgs/dluq-dm.svg"
                                                                         width="311" height="40"
                                                                         alt="Đại lý ủy quyền SKF chính hãng"></a></div>
                    <div class="info">
                        ...
                        Website: <strong>NGOCANH.COM</strong> - Email: <a href="mailto:info@ngocanh.com"
                                                                          target="_top"
                                                                          rel="nofollow">info@ngocanh.com</a>

                        Hotline: <a href="tel:096 123 8558" title="báo giá vòng bi SKF chính hãng"
                                    rel="nofollow">096 123 8558</a> - <a href="tel:033 999 5999"
                                                                         title="báo giá vòng bi SKF chính hãng"
                                                                         rel="nofollow">033 999 5999</a> - <a
                            href="tel:0763 356 999" title="báo giá vòng bi SKF chính hãng" rel="nofollow">0763 356
                        999</a>
                    ...
                    <div class="social-icons" style="padding: 5px 0 0;">
                        <a rel="nofollow" href="https://www.facebook.com/skfngocanh.vn" target="_blank"><span
                                style="margin-right: 10px">
                                    ...
                                    <img src="./assets/icon-social/facebook.png" width="24" height="24"
                                         alt="Facebook"> </span></a>

                        <a rel="nofollow" href="https://twitter.com/skfngocanh" target="_blank"><span
                                style="margin-right: 10px">

                                    <img src="./assets/icon-social/twitter.png" width="24" height="24"
                                         alt="twitter"> </span></a>
                    ...
                    <a href="http://online.gov.vn/Home/WebDetails/54138" target="_blank" rel="nofollow"><img
                            ...
                            src="./assets/imgs/logoSaleNoti.png" width="125" height="47"></a>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col 1" style="color: #0059a5">
                            <ul class="list-unstyled">
                                <li>Về chúng tôi</li>
                                <li><a href="dai-ly-uy-quyen-vong-bi-skf.html" title="Đại lý ủy quyền SKF">Đại lý ủy
                                    quyền SKF</a></li>
                                <li><a href="gioi-thieu.html" title="Giới thiệu chung" rel="nofollow">Giới thiệu
                                    chung</a></li>
                                <li><a href="profile-skf-ngoc-anh.pdf" title="Profile công ty" rel="nofollow"
                                       target="_blank">Profile công ty</a></li>
                                <li><a href="bao-chi-noi-ve-chung-toi/index.html" title="Báo chí nói về chúng tôi"
                                       rel="nofollow" target="_blank">Báo chí nói về chúng tôi</a></li>
                                <li><a href="tai-lieu-vong-bi.html" title="Tài liệu tra cứu SKF">Tài liệu tra cứu
                                    SKF</a></li>
                                <li><a href="catalogue.html" title="Download Catalogue SKF">Download Catalogue
                                    SKF</a></li>
                                <li><a href="bao-gia-vong-bi-skf-chinh-hang.html"
                                       title="Báo giá vòng bi SKF chính hãng">Báo giá vòng bi SKF chính hãng</a>
                                </li>

                                <li><a href="dich-vu-ky-thuat-skf.html" title="Dịch vụ kỹ thuật">Dịch vụ kỹ
                                    thuật</a></li>
                                <li><a href="tu-van-lua-chon-vong-bi-mien-phi.html"
                                       title="Báo giá vòng bi SKF chính hãng">Tư vấn lựa chọn vòng bi</a></li>




                                <li class="bct_reg"><span
                                        style="font-size: 11px; color: #000; font-weight: 300;">SKF Authorized
                                            Distributor</span>
                                    <a href="dai-ly-uy-quyen-vong-bi-skf.html"><img class="lazyload"
                                                                                    src="./assets/imgs/dluq.svg"
                                                                                    width="168" height="38"
                                                                                    alt="Đại lý ủy quyền SKF chính hãng"></a>
                                </li>

                                <li class="bct_reg"><span
                                        style="font-size: 11px; color: #000; font-weight: 300;">Phương thức thanh
                                            toán</span>
                                     <a href="thanh-toan.html" rel="nofollow"><img class="lazyload"
                                                                                      src="./assets/imgs/icon-thanhtoan.png"
                                                                                      width="168" height="28"
                            ...
                            <a href="http://www.dmca.com/Protection/Status.aspx?ID=944ba1c7-8a8c-411a-9669-fe6e45503bc3"
                               title="DMCA.com Protection Status" class="dmca-badge"> <img class="lazyload"
                                                                                           src="../images.dmca.com/Badges/dmca-badge-w100-5x1-028228.png?ID=944ba1c7-8a8c-411a-9669-fe6e45503bc3"
                        ...
                        <div class="col-md-4 col-sm-4 col 2" style="color: #0059a5">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="chinh-sach-bao-mat.html" title="Chính sách bảo mật"
                                       rel="nofollow">Chính sách bảo mật</a></li>
                                <li><a href="dieu-kien-doi-tra-hang.html" title="Bảo hành - đổi trả hàng"
                                       rel="nofollow">Bảo hành - đổi trả hàng</a></li>
                                <li><a href="hoi-dap.html" title="Câu hỏi thường gặp" rel="nofollow">Câu hỏi thường
                                    gặp</a></li>
                                <li><a href="huong-dan-mua-hang.html" title="Hướng dẫn mua hàng"
                                       rel="nofollow">Hướng dẫn mua hàng</a></li>
                                <li><a href="thanh-toan.html" title="Hình thức thanh toán" rel="nofollow">Hình thức
                                    thanh toán</a></li>
                                ...
                                <li><a href="tai-lieu-vong-bi/luu-y-khi-mua-vong-bi-skf-chinh-hang.html"
                                       title="Những lưu ý trước khi mua vòng bi SKF" rel="nofollow">Những lưu ý
                                    trước khi mua hàng</a></li>

                                <li class="bct_reg"><span
                                        style="font-size: 11px; color: #000; font-weight: 300;">Liên kết
                                            website</span></li>
                                <li><a href="http://timvongbi.com/" title="Tìm vòng bi" rel="nofollow"
                                       target="_blank"><i class="glyphicon glyphicon-link
"></i> timvongbi.com</a></li>
                                <li><a href="https://www.skf.com/vn" title="SKF Việt Nam" rel="nofollow"
                                       target="_blank"><i class="glyphicon glyphicon-link
"></i> skf.com</a></li>
                                <li><a href="https://ngocanhgroup.vn/" title="Ngọc Anh Group" rel="nofollow"
                                       target="_blank"><i class="glyphicon glyphicon-link
"></i> ngocanhgroup.vn</a></li>
                        ...
                        <div class="col-md-4 col-sm-4 col 3" style="color: #0059a5">
                            <ul class="list-unstyled">
                                ...
                                <li><a href="san-pham/vong-bi-skf.html" title="Vòng bi SKF chính hãng">Vòng bi SKF
                                    chính hãng</a></li>
                                <li><a href="san-pham/goi-do-skf.html" title="Gối đỡ SKF chính hãng">Gối đỡ SKF
                                    chính hãng</a></li>
                                <li><a href="san-pham/mo-boi-tron-SKF.html" title="Mỡ bôi trơn SKF chính hãng">Mỡ
                                    bôi trơn SKF chính hãng</a></li>
                                <li><a href="day-dai-SKF-chinh-hang.html" title="Dây đai SKF chính hãng">Dây đai SKF
                                    chính hãng</a></li>
                                <li><a href="san-pham/phot-chan-skf.html" title="Phớt chặn dầu SKF chính hãng">Phớt
                                    chặn SKF chính hãng</a></li>
                                <li><a href="xich-tai-skf.html" title="Xích tải SKF chính hãng">Xích tải SKF chính
                                    hãng</a></li>

                                <li><a href="san-pham/dung-cu-skf.html" title="Dụng cụ SKF chính hãng">Dụng cụ bảo
                                    trì SKF chính hãng</a></li>
                                <li><a href="san-pham/vong-bi-xe-may.html"
                                       title="Vòng bi xe máy SKF chính hãng">Vòng bi xe máy SKF chính hãng</a></li>


                                <li class="bct_reg"><span
                                        style="font-size: 11px; color: #000; font-weight: 300;">SKF Authenticate
                                            App</span></li>
                                <li><a href="tai-lieu-vong-bi/SKF-Authenticate.html"><img
                                        src="./assets/imgs/SKF-Authenticate.png" width="168" height="28"
                                        alt="SKF Authenticate - Phần mềm kiểm tra vòng  bi SKF giả"></a></li>


                                <li class="bct_reg"><a href="kiem-tra-vong-bi-gia-skf.html"
                                                       title="Cách phân biệt vòng bi SKF giả">Cách phân biệt vòng bi SKF
                                    giả</a>
                                </li>
                                <li><a href="tai-lieu-vong-bi/xuat-xu-vong-bi-skf.html"
                                       title="Xuất xứ vòng bi SKF chính hãng">Xuất xứ vòng bi SKF chính hãng</a>
                                </li>
    ...
    <div class="footer-adwords-seo">
        <div class="container">
            <div class="adwords-content" style="line-height: 20px; font-size: 11px;">
                ...
                <a href="tai-lieu-vong-bi/SKF-Authenticate.html" title="SKF Authenticate App">SKF Authenticate
                    App</a>
        ...
        <div class="copyright" style="font-size:11px; color:#5f5f5f">
            <div class="container">
                ...
                <span style="font-weight: 300">Để tránh mua phải vòng bi SKF giả (fake) kém chất lượng. Cách tốt
                        ...
                        ủy quyền của SKF | <a href="https://www.skf.com/vn/organisation/brand-protection"
                                              target="_blank" rel="nofollow"><strong>skf.com/genuine</strong></a></span>
