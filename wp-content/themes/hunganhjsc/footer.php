                        ...
                        if(isset($spChinhHang)){
                            foreach($spChinhHang as $spChinhHangItem){
                                ...
                                <div class="col-sm-3 col-xs-6 col">
                                    <span class="icon">
                                        <img class="lazyload" src="<?php echo $spChinhHangItem['anh']['url']?>" width="28"height="28">
                                    </span>
                                    <span class="text" style="font-weight: 500; font-size: 14px;  text-transform: uppercase;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-info">
                    ...
                    <?php $icons = get_field('icon_mang_xa_hoi','option');
                        if(isset($icons)){
                            foreach($icons as $iconItem){
                                echo wp_get_attachment_image($iconItem, 'full', false, array('class' => 'width-24px'));
                            }
                        }
                    ?>
                    <br>
